...
@Component({
  selector: "app-submitted-schools",
  templateUrl: "./submitted-schools.component.html",
  styleUrls: ["./submitted-schools.component.scss"],
})
export class SubmittedSchoolsComponent implements OnInit {
  ...
  title: string = "Submitted Schools";
  actions = ["View"];
      ...
      .pipe(
        map((resp: any) => {
          if (resp["status"] === 0) {
            ...
            // this.rows = this.rows.filter((row: any) => row.status === "SUBMITTED");
