...
@Component({
  selector: "app-own-login-history",
  templateUrl: "./own-login-history.component.html",
  styleUrls: ["./own-login-history.component.scss"],
})
export class OwnLoginHistoryComponent implements OnInit {
