...
@Component({
  selector: "app-list-school-documents",
  templateUrl: "./list-school-documents.component.html",
  styleUrls: ["./list-school-documents.component.scss"],
})
export class ListSchoolDocumentsComponent implements OnInit {
    ...
    .subscribe(
      (res: any) => {
        ...
        if (res.status === 0) {
          ...
          console.log(this.documentDetails, 'detailed profile');
