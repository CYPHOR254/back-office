...
@Component({
  selector: "app-clarification-schools",
  templateUrl: "./clarification-schools.component.html",
  styleUrls: ["./clarification-schools.component.scss"],
})
export class ClarificationSchoolsComponent implements OnInit {
  @Input() formData: any;
  ...
  title: string = "Clarification Schools";
  actions = ["View"];
