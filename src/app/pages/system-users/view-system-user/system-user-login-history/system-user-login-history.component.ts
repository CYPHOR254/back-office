...
@Component({
  selector: 'app-system-user-login-history',
  templateUrl: './system-user-login-history.component.html',
  styleUrls: ['./system-user-login-history.component.scss']
})
export class SystemUserLoginHistoryComponent implements OnInit {
  public modalRef!: NgbModalRef;
  @Input () systemUserId:any|undefined;
  loading: boolean = true;
  rows: any = [];
  filteredRows: any = [];
  defaultNavActiveId = 1;
  allRecords: any;
  title: string = "System User Login History";
