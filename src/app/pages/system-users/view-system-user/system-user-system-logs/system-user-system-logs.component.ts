...
@Component({
  selector: 'app-system-user-system-logs',
  templateUrl: './system-user-system-logs.component.html',
  styleUrls: ['./system-user-system-logs.component.scss']
})
export class SystemUserSystemLogsComponent implements OnInit {
