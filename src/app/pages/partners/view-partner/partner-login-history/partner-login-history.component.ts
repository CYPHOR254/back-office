...
@Component({
  selector: "app-partner-login-history",
  templateUrl: "./partner-login-history.component.html",
  styleUrls: ["./partner-login-history.component.scss"],
})
export class PartnerLoginHistoryComponent implements OnInit {
