...
@Component({
  selector: "app-agent-system-logs",
  templateUrl: "./agent-system-logs.component.html",
  styleUrls: ["./agent-system-logs.component.scss"],
})
export class AgentSystemLogsComponent implements OnInit {
