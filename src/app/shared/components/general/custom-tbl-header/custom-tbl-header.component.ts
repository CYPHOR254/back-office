...
export class CustomTblComponent {
  ...
  total: any;
  perPage = 10;
  pageSizes: number[] = [10, 20, 50, 100, 1000];
  pageSize = 20;
  page = 1;
  dataLoaded = false;
